...
| `ant-low-words` | максимальная экономия слов / caveman-inspired, но уважительно | 20–80 слов |
...
## Быстрая установка после публикации на GitHub

Когда репозиторий будет опубликован, можно будет установить через skills-compatible CLI:
